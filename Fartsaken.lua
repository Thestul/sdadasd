-- Mock the API to avoid external dependency
local api = {
    check_key = function(key)
        return { code = "KEY_VALID", message = "Key valid! Loading script...", data = { auth_expire = os.time() + 3600, total_executions = 1 } }
    end,
